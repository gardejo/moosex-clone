...
package MooseX::Clone::Meta::Attribute::Trait::DataClone;
use Moose::Role;
...
sub Moose::Meta::Attribute::Custom::Trait::DataClone::register_implementation { __PACKAGE__ }
...
MooseX::Clone::Meta::Attribute::Trait::DataClone - The L<Moose::Meta::Attribute>
trait for deeply cloning attributes using L<Data::Clone>.
...
=head1 SYNOPSIS
    ...
    my $clone = $object->clone; # $clone->foo will equal Data::Clone::clone($object->foo)
